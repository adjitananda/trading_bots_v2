...
from trading_lib.optimizer.triggers import check_triggers
from trading_lib.optimizer.parameter_updater import set_risk_multiplier, set_halted, is_halted, get_risk_multiplier
...
class RiskManager:
    ...
    def resume_conditions_met(self) -> bool:
        ...
        from trading_lib.optimizer.metrics import calculate_current_drawdown
