...
class TripleMAStrategy(BaseStrategy):
    """Тройная стратегия скользящих средних (быстрая, средняя, медленная)"""
...
class RSIOversoldStrategy(BaseStrategy):
    """Стратегия по RSI (перекупленность/перепроданность)"""
...
class StochasticStrategy(BaseStrategy):
    """Стратегия по стохастическому осциллятору"""
...
class MACDWithEMAStrategy(BaseStrategy):
    """Комбинированная стратегия: MACD + EMA"""
...
class RSIWithMAStrategy(BaseStrategy):
    """Комбинированная стратегия: RSI + MA"""
...
class ATRBreakoutStrategy(BaseStrategy):
    """Стратегия пробоя на основе ATR"""
...
class StrategyFactory:
    ...
    _strategies = {
        ...
        'macd': MACDStrategy,
        'macd_with_ema': MACDWithEMAStrategy,
        'rsi_with_ma': RSIWithMAStrategy,
